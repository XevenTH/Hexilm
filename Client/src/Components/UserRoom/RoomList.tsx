...
export default observer(function RoomList() {
  ...
  const [filterRoom, setFilterRoom] = useState<UserRoom[]>([])
        ...
        <>
          {isLoading ? (
            ...
            <div className="grid md:grid-cols-3">
              {userRooms.map((room) => (
                <div
                  className="duration-200 max-w-lg bg-gray-800 max-h-96 m-4 hover:m-3 rounded-lg drop-shadow-lg cursor-pointer"
                  key={room.id}
                  onClick={() => {
