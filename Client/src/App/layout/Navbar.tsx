...
function Navbar() {
    ...
    return (
        <nav className="relative z-10 backdrop-blur-lg bg-[#181823]">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden sm:block">
                        <div className="relative">
                            ...
                            {isOpen && (
                                <div
                                    className="absolute right-0 w-56 mt-2 origin-top-right bg-slate-100 rounded-md shadow-lg z-10"
            ...
            >
                <div
                    className="absolute right-0 w-56 mt-2 origin-top-right bg-white rounded-md shadow-lg z-10 text"
                    onClick={() => setIsOpen(false)}
                >
                    <div
                        className="py-1"
                    ...
                    >
                        <div
                            className="inline-flex px-4 py-2 text-md font-semibold text-gray-700 hover:bg-gray-100 hover:text-gray-900 z-10">
